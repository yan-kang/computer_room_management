...
public interface IAppointmentRecordService {
    ...
    String useInfo(HttpServletRequest httpServletRequest);
    ...
    String showAppoint(HttpServletRequest httpServletRequest);
    String dealAppoint(HttpServletRequest httpServletRequest);
    String showDealHistory(HttpServletRequest httpServletRequest);
}
